...
RECOMMENDED_DOCS = {
    "BRAINDUMP.md": {
        "purpose": "Customer's voice — what to build. The entry point for the lifecycle.",
        "suggestion": (
            "Run 'aidlc init' to scaffold one, then write what you want built.\n"
            "  This is the single source of truth for AIDLC planning."
        ),
    },
    "ROADMAP.md": {
        ...
        "suggestion": (
            ...
            "scope from BRAINDUMP.md, code, and architecture/design docs."
        ),
    },
    "README.md": {
    ...
    "ARCHITECTURE.md": {
        ...
        "suggestion": (
            "Describe your system's components manually, or run 'aidlc init --with-docs'\n"
            "  to copy a template you can fill in."
        ),
    },
    "DESIGN.md": {
...
OPTIONAL_DOCS = {
    "STATUS.md": {
        "purpose": "Current state of the codebase (auto-generated by 'aidlc run --audit')",
        "suggestion": "Run 'aidlc run --audit' to generate this automatically.",
    },
    "planning/": {
